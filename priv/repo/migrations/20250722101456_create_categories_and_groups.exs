defmodule EveIndustrex.Repo.Migrations.CreateCategoriesAndGroups do
  ...
  def change do
    ...
    create table("groups", primary_key: false) do
      add :category_id,
          references(:categories, column: :category_id, type: :bigint, on_delete: :delete_all)
    ...
    alter table("bp_product_types") do
      modify :bp_product,
             references(:types, column: :type_id, type: :bigint, on_delete: :delete_all),
             from: references(:types, column: :type_id, type: :bigint)

      modify :type, references(:types, column: :type_id, type: :bigint, on_delete: :delete_all),
        from: references(:types, column: :type_id, type: :bigint)
    end
