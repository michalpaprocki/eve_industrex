defmodule EveIndustrex.Test.EsiFixtures do
  ...
  def strategy_fixture(resource) do
    %Sync.EsiSyncStrategy{}
    |> Sync.EsiSyncStrategy.changeset(Sync.SyncProvider.default_strategy(1, resource))
  ...
  def metadata(
        etag \\ nil,
        expires_at \\ nil,
        last_modified \\ DateTimeParser.parse_datetime!("Fri, 19 Jun 2026 07:31:36 GMT",
          to_utc: true
        )
  ...
  def esi_response(
        ...
        last_modified \\ "Fri, 19 Jun 2026 07:31:36 GMT"
      ) do
    {:ok,
     %Response{
       status: status,
