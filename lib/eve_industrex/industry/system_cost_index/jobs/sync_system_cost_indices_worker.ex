defmodule EveIndustrex.Industry.SystemCostIndex.Jobs.SyncSystemCostIndicesWorker do
  ...
  def perform(%Oban.Job{args: args, attempt: attempt, max_attempts: max_attempts}) do
    ...
    case Orchestrator.initiate_resource_sync(strategy_id, attempt, max_attempts, &Client.fetch_system_cost_indices/3) do
      {:snooze, delay} ->
    ...
    EveIndustrex.Industry.SystemCostIndex.Jobs.SyncSystemCostIndicesFinalizer.new(%{"strategy_id" => strategy_id}) |> Oban.insert()
  end
end
