defmodule EveIndustrex.Industry.BlueprintActivity do
  ...
  schema "blueprint_activities" do
    ...
    belongs_to :blueprint, Blueprint,
      references: :blueprint_type_id,
      define_field: false,
      foreign_key: :blueprint_type_id,
      type: :integer

    has_many :materials, EveIndustrex.Industry.BlueprintActivityMaterial,
      references: :blueprint_type_id,
      foreign_key: :blueprint_type_id

    has_many :products, EveIndustrex.Industry.BlueprintActivityProduct,
      references: :blueprint_type_id,
      foreign_key: :blueprint_type_id
