defmodule EveIndustrex.Market.Composer do
  @moduledoc """
  ...
  defp build_location(location_id) do
    case Universe.Station.Store.get_station(location_id) do
      {station_id, station_name, _sys_id, sys_name, security_status, _con_id, con_name, _reg_id,
       reg_name} ->
        %{
