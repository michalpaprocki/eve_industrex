defmodule EveIndustrex.Market.AveragePrice.Service do
  ...
  def project_average_prices(tid) do
    ...
    query = from(ap in AveragePrice, join: t in subquery(subquery), on: ap.type_id == t.type_id,
    select: %{
      type_id: ap.type_id,
  ...
  defp to_ets_ap_row(average_price) do
      ...
      {average_price.type_id, average_price.name, average_price.average_price, average_price.adjusted_price}
