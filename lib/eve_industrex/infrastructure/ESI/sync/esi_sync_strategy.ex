defmodule EveIndustrex.Infrastructure.ESI.Sync.EsiSyncStrategy do
  ...
  schema "esi_sync_strategies" do
      ...
      field :last_etag, :string
      field :last_expires_at, :utc_datetime
  ...
  def changeset(strategy, attrs) do
    strategy
    |> cast(attrs, [:last_modified, :sync_interval_seconds, :target_id, :last_etag, :last_expires_at, :last_successful_sync, :status, :next_run_at, :enabled, :next_generation, :resource_type_id, :last_etag, :last_expires_at])
  end
end
